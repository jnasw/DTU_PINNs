...
@hydra.main(config_path="src/conf", config_name="setup_dataset_o_e.yaml",version_base=None)
def main(config):
    ...
    modelling_full=SynchronousMachineModels(config) # Define the set of ODEs to be used
    ...
    flag_for_time = False # Flag to indicate if time to solve is printed
    SM_model.solve_sm_model(init_conditions, modelling_full, flag_for_time) # Solve the model for the various initial conditions and save the trajectories with the desired frequency
